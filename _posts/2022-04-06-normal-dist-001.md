...
<img src="https://raw.githubusercontent.com/meiyulee/pic001/master/stat/Normal_dist_003.JPG" width="400">
...
$$
f_X(ln(Y))=f_Y(y)=\frac{1}{\sqrt{2 \: \pi} \: \sigma \, y} \times e^{\frac{-1}{2} \: \left(\frac{ln(y)-\mu}{\sigma} \right)^{2}}, - \infty < x < \infty
\tag{7}
$$

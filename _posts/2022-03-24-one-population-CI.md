---
title: 區間估計電腦幫你算？還是Follow觀念更重要
description: 你以為使用區間估計計算器沒有問題？先建立基本觀念比計算更重要。本文發覺網上會提供區間估計的計算器，但他們真的是可以幫你的數據計算出正確的信賴區間嗎？繼續閱讀本文讓我慢慢分享給你了解。
author: 李玫郁
date: 2022-03-21
categories:
 - 統計觀念
...
> 區間估計和假設檢定是統計學中的第二和第三步。第一步是找到統計量，做點估計。
> 區間估計和假設檢定計算都不難，Excel或統計套裝軟體都能跑出來。但是軟體內有沒有問題呢？哪裡會出問題？
...
上式中的$Z$是指標準化的意思，也就是Z score，非指Z分配。只有當確定可以趨近常態分配後才能使用Z分配。$(1 - \alpha)\times 100$% 為信賴水準，$0<\alpha<1$。
